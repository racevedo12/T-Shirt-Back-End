const seedItems = [
  ...
  {
    name: "Shoes",
    description: " used shoes like new 🤪 size: 7 ",
    price: "1",
    image:
  ...
  },
  {
    name: "Sippy Cup",
    description:
      "Let’s face it: toddlers are a messy bunch, especially when first navigating sippy cups. Now imagine a world in which drinks didn’t spill at all ",
    price: "7",
    image:
